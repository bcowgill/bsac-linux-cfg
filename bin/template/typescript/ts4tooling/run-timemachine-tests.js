...
// Run a test with a specific timemachine time configuration
...
test(
	'should now be set to December 25, 1991 12:12:59 via GMT dateString',
	{
...
test(
	'should now be set to December 25, 1991 12:12:59 via timestamp',
	{
...
test(
	'should now be set to December 25, 1991 12:12:59 via localtime dateString',
	{
