   // becomes Weird as default export
   export namespace Weird
   {
	  // becomes Weird.FWeird exported on the namespace
	  ...
	  export class CWeird
	  {
		 ...
		 // becomes Weird.CWeird() constructor function
		 constructor(
			public name: string,
		 ...
		 // becomes Weird.CWeird.statics() as a static method
		 static statics()
		 {
			console.log( `${CWeird.klass} statics called` );
		 }

		 // becomes Weird.CWeird.staticArrow() as a static method
		 static staticArrow = () =>
		 {
			console.log( `${CWeird.klass} staticArrow called` );
		 }

		 // becomes Weird.CWeird.prototype.whatever() as an instance method
		 whatever()
		 {
		 ...
		 // becomes Weird.CWeird.prototype.publics() as an instance method
		 public publics()
		 {
		 ...
		 // becomes Weird.CWeird.prototype.privates() as an instance method
		 private privates()
		 {
		 ...
		 // becomes Weird.CWeird.prototype.protecteds() as an instance method
   ...
   console.log( `Weird.CWeird.klass = ${Weird.CWeird.klass}` );
   Weird.CWeird.statics();
   Weird.CWeird.staticArrow();
