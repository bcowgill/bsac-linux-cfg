...
function usage {
	...
	cmd=$(basename $0)
	echo "
$cmd reasons that you are sad [--help|--man|-?]

This will make a record in your timeclock file [$FILE] that you were sad about something during the day/sprint.
...
sad.sh Some team members constantly late to the daily meeting and it goes long.
"
	exit $code
}
if [ "$1" == "--help" ]; then
