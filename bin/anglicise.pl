...
sub usage
{
	my ($code) = @ARG;
	print <<"USAGE";
$FindBin::Script [--help|--man|-?] [filename ...]

Filter standard input or specified files anglicising any foreign alphabet characters and numbers.

--man   Shows help for this tool.
--help  Shows help for this tool.
-?      Shows help for this tool.

See also utf8tr.pl, math-rep.pl, utf8-ellipsis.pl, utf8-filter.pl, utf8ls-letter.sh, utf8ls-number.sh, utf8ls.pl
USAGE
	exit($code || 0);
}
...
my %R = (
	...
	d => [qw( ď đ ƌ ȡ ɖ ɗ ͩ ᵭ ᶁ ᶑ ḋ ḍ ḏ ḑ ḓ ⒟ ⓓ ｄ 󠁤 )], # d1

	D => [qw( Ď Đ Ɗ Ƌ Ḋ Ḍ Ḏ Ḑ Ḓ Ⓓ Ｄ 🄓 🄳 🅓 🅳 󠁄 )], # D2 ǅ ǲ
	...
	l => [qw( ĺ ļ ľ ŀ ł ƚ ȴ ɫ ɬ ɭ ᶅ ᷝ ḷ ḹ ḻ ḽ ₗ ⒧ ⓛ ⱡ ⳑ ꝉ ꞎ ｌ 󠁬 )], # l1

	L => [qw( Ĺ Ļ Ľ Ŀ Ł Ƚ Ḷ Ḹ Ḻ Ḽ Ⓛ Ⱡ Ɫ Ⳑ Ꝉ Ｌ 🄛 🄻 🅛 🅻 󠁌 )], # L2 ǈ
	...
	n => [qw( ñ ń ņ ň ŉ ƞ ǹ ȵ ɲ ɳ ᵰ ᶇ ᷠ ṅ ṇ ṉ ṋ ⁿ ₙ ⒩ ⓝ ꞑ ꞥ ｎ 󠁮 )], # n1

	N => [qw( Ñ Ń Ņ Ň Ɲ Ǹ Ƞ Ṅ Ṇ Ṉ Ṋ Ⓝ Ꞑ Ꞥ Ｎ 🄝 🄽 🅝 🅽 󠁎 )], # N2 ǋ
	...
	z => [qw( ź ż ž ƶ ȥ ɀ ʐ ʑ ᵶ ᶎ ᷦ ẑ ẓ ẕ ⒵ ⓩ ⱬ ｚ 󠁺 )], # z1 ǅ ǲ

	Z => [qw( Ź Ż Ž Ƶ Ȥ Ẑ Ẓ Ẕ Ⓩ Ⱬ Ɀ Ｚ 🄩 🅉 🅩 🆉 󠁚 )], # Z2
...
# 'utf8ls-letter.sh L with' used to generate:
	...
	d => [qw( ď đ ƌ ȡ ɖ ɗ ᵭ ᶁ ᶑ ḋ ḍ ḏ ḑ ḓ )], # d3
	D => [qw( Ď Đ Ɗ Ƌ Ḋ Ḍ Ḏ Ḑ Ḓ )], # D4 ǅ ǲ
	...
	l => [qw( ĺ ļ ľ ŀ ł ƚ ȴ ɫ ɬ ɭ ᶅ ḷ ḹ ḻ ḽ ⱡ ꝉ ꞎ )], # l3
	L => [qw( Ĺ Ļ Ľ Ŀ Ł Ƚ Ḷ Ḹ Ḻ Ḽ Ⱡ Ɫ Ꝉ )], # L4 ǈ
	m => [qw( ɱ ᵯ ᶆ ḿ ṁ ṃ )],
	M => [qw( Ḿ Ṁ Ṃ Ɱ )],
	n => [qw( ñ ń ņ ň ƞ ǹ ȵ ɲ ɳ ᵰ ᶇ ṅ ṇ ṉ ṋ ꞑ ꞥ )], # n3
	N => [qw( Ñ Ń Ņ Ň Ɲ Ǹ Ƞ Ṅ Ṇ Ṉ Ṋ Ꞑ Ꞥ )], # N4 ǋ
	...
	z => [qw( ź ż ž ƶ ȥ ɀ ʐ ʑ ᵶ ᶎ ẑ ẓ ẕ ⱬ )], # z3 ǅ
	Z => [qw( Ź Ż Ž Ƶ Ȥ Ẑ Ẓ Ẕ Ⱬ Ɀ )], # Z4
