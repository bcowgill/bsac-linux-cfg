...
tar cvzf workspace/backup/ontology-home-cfg.tgz .gitconfig .viminfo .lesshist .bash_history .charles.config .charles .kde/Autostart .kde/env .kde/share .Ontology_Modeller_Workspace
popd
